...
from pylcl.ast import LclBinary, LclCompare, LclUnary
from pylcl.ast.operators import BinaryOperator, ComparisonOperator, UnaryOperator
...
async def _evaluate_operation(
    ...
    return await _compare(node, resolver, evaluate)
